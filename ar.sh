...
rice_packages="git neovim unzip stow opendoas xorg-xinit dmenu pulseaudio alsa-utils inotify-tools reflector expect bspwm sxhkd xdo xorg base-devel zsh zsh-completions"
