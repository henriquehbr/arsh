...
rice_packages="git neovim unzip stow opendoas xorg-xauth sx dmenu pulseaudio alsa-utils inotify-tools reflector expect xorg bspwm sxhkd xdo base-devel zsh zsh-completions scrot fzf dunst libnotify"
